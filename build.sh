...
wget -q  $(curl https://raw.githubusercontent.com/ZyCromerZ/Clang/main/Clang-main-link.txt 2>/dev/null) -O "ZyC-Clang-21.tar.gz"
mkdir ~/zyc-clang
tar -xf ZyC-Clang-21.tar.gz -C ~/zyc-clang
rm -rf ZyC-Clang-21.tar.gz
fi
